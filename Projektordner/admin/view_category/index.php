<?php
  ...
  if (!isset($_SESSION["user"]) || $_SESSION["role"] != "admin"){ //Ist die Session nicht gesetzt oder der Nutzer kein Admin wird man auf die Login Seite weitergeleitet.
    ...
    function view_category($conn){  //Gibt alle Nutzer in einer Tabelle aus.
...
<html lang="de">
    <head>
        ...
        <nav class="navbar navbar-default">
            ...
            <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-inbox"></span> Kategorien ansehen</button></form>
