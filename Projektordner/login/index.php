...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	validatelogin();
		...
		if(empty($error)){
			...
			{$message .= "Sie wurden erfolgreich eingeloggt";login($username,$row["id"],$row["role"]);}
			else{$error .= "Ungültiges Password oder Nutzername";}}
			else{$error .= "Ungültiges Password oder Nutzername";}}
	}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <nav class="navbar navbar-default">
             ...
             <div class="nav navbar-nav navbar-left"></div></div></nav>
  <div class="well well-sm"><h4>Login Seite</h4>  </div>
		<div class="container">
			<p>
