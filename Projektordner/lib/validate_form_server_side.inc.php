...
//Formfeldes suchen und bearbeiten
      ...
      if(isset($_POST['category_ID'])){
        ...
        }else{$error .= "Geben Sie bitte einen Status an. <br />";}
        ...
        if(isset($_POST['date']) && !empty($_POST['date'])){ 
          ...
          }else{$error .= "Bitte geben Sie ein gültiges Datum ein. Format Jahr/Monat/Tag <br />";} 
        }
        else{$error .= "Geben Sie bitte ein Fälligkeitsdatum ein. <br />";}} //Falls das Datumfeld nicht ausgefüllt wurde.
    ...
    function validatelogin(){global $error,$username,$password;
    // username
	...
	if(!empty(trim($_POST['password']))){
        ...
        function validateUser(){global $error,$firstname,$lastname,$username,$password;
        ...
        if(isset($_POST['lastname']) && !empty(trim($_POST['lastname'])) && strlen(trim($_POST['lastname'])) <= 30){
         ...
         function validateCategory(){global $category,$error;
